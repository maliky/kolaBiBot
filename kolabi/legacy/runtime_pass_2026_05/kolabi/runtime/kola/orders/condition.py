...
class Condition:
    ...
    def __init__(self, brg: BargainLike, cond, logLevel_: str = "INFO") -> None:
        """
    ...
    def __repr__(self, short: bool = True) -> str:
    ...
    def get_excludeIDs(self) -> Set[str]:
        self.logger.debug(f"self.excludeIDs={self.excludeIDs}")
        return self.excludeIDs

    def set_excludeClIDs(self, exclIDs: Optional[Sequence[str]] = None):
        """Add the sequence exclIDs to self."""
        # Evite une liste mutable partagee entre appels.
        if exclIDs is None:
            exclIDs = []
    ...
    def set_price_val(self, price_ref: str, val: float) -> None:
    ...
    def verifie_forme(self, cond: Series) -> bool:
    ...
    def evalue_une_condition(self, cond: Series) -> bool:
    ...
    def is_(self, t_value: bool) -> bool:
        """
    ...
    def evalue_un_hook(self, cond_) -> bool:
        """
        Evalue a hook.
    ...
    def get_low_high(self, _genre: str):
    ...
    def get_conds(self, genre_: str, pricetype_: str = "*") -> DataFrame:
    ...
    def _get_price_conds(self, pricetype_: str = "*") -> DataFrame:
    ...
    def get_current_price(self, pricetype_: Optional[str] = None) -> float:
        """
        ...
        assert _pricetype is not None, "No price type available for current price"
    ...
    def get_price_type(self) -> Optional[str]:
        """
    ...
    def update_cond(self, genre_: str, op_: str, value_):
        """ "
