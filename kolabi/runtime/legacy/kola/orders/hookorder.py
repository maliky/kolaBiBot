...
class HookOrder(OrderConditionned):
    ...
    def __init__(
        ...
        brg: BargainLike,
        logLevel_: str = "INFO",
        excludeIDs_: Optional[Set[str]] = None,
        symbol: str = "XBTUSD",
    ) -> None:
        """
        ...
        self.symbol = symbol
        self.relative_values: dict[str, object] = {}
    ...
    def run(self):
        ...
        execValidation: dict[str, object] = {}
        while not self.stop:
    ...
    def update_prices_with_relative_values(self) -> None:
    ...
    def update_cond_with_relative_values(self) -> None:
    ...
    def get_new_cond_values(self, genre_: str, op_: str):
    ...
    def conditions_remplies(self) -> bool:
