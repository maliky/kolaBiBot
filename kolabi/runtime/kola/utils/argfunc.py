...
def get_args():
    ...
    parser.add_argument(
        ...
        default=[-1, 800],
        help=(
            "le temps en minute à partir du moment du lancement, doit être un tuple, "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Indique une durée de pause lorsqu'un ordre fini. C'est approximatif.  "
    ...
    parser.add_argument(
        ...
        nargs=2,
        help=(
            "Une fourchette de prix dans laquelle executer le ou les essais.  "
    ...
    parser.add_argument(
        ...
        default=75,
        help=(
            "Quantité de l'ordre.  Doit toujours être positive ici.  Mais peut être exprimé "
    ...
    parser.add_argument(
        ...
        default=2,
        help=(
            "C'est l'epaisseur de la queue (tail) qui suit le prix;  en %%, valeur absolue ou "
            "prix de départ."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=60,
        help=(
            "Le temps (moyen) entre deux logs de l'évolution des prix."
        ),
    )
    parser.add_argument(
        "--argFile",
        ...
        default=None,
        help=(
            "Indique le nom d'un fichier contenant multiples orders to run in one go."
        ),
    )
    parser.add_argument(
        "--oDelta",
    ...
    parser.add_argument(
        ...
        default=PRICE_PRECISION["XBTUSD"],
        help=(
            "Difference between trigger price and price for tail orders."
        ),
    )
    parser.add_argument(
        "--nbEssais",
        ...
        type=int,
        default=3,
        help=("nombre d'essaies à effectuer."),
    )
    parser.add_argument(
        "--oType",
        "-o",
        ...
        default="M",
        help=(
            "Declenchement price type. One of one of fairPrice, markPrice, lastPrice, "
    ...
    parser.add_argument(
        ...
        default="Si-",
        help=(
            "One of fairPrice, markPrice, lastPrice, respectivement pour le déclenchement "
    ...
    parser.add_argument(
        ...
        default="p%%q%%t%%",
        help=(
            "Défini comment interpréter les arguments --prix (p), --quantity (q), --tailPrice (t). "
