...
class PriceObj:
    ...
    def get_current_prices(
        ...
        sOfsD: Optional[float] = None,
        sOfsP: Optional[float] = None,
        fOfsD: Optional[float] = None,
    ...
    def __repr__(self, short: int = 3) -> str:
    ...
    def flexTail_offset_delta(self, refPrice: Optional[float] = None) -> tuple[float, float]:
    ...
    def get_refTail(self, refPrice: Optional[float] = None) -> float:
        """
    ...
    def new_current_stopTail(self) -> bool:
    ...
    def get_current_variation(self) -> tuple[float, float, float]:
    ...
    def get_scale(self, current_var: float) -> float:
        """
        implémente e^-f(t)
    ...
    def is_stopTail(self, tail: float) -> bool:
        """
    ...
    def get_data(
        ...
        nomElt: str,
        temps: str = "current",
        default_ret: Optional[float] = None,
    ):
        """
    ...
    def get_refPrice(self, refPrice: Optional[float] = None) -> float:
...
def not_array(arr: Iterable[bool]) -> Iterator[bool]:
...
def create_index(core_size_: int) -> list[str]:
    """
...
def neg_exps_values(max_var: float, N: int) -> list[float]:
